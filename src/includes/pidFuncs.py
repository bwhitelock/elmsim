...
def randomByte(parent,pidMode,minValue,maxValue,data):
    print "randomByte"
    response = "%02X" % rand(0,255)
    response = "%s%s%s" % ((40+pidMode),data[3:4], response)
    return response
...
def modeFunc_04(parent,pidMode,minValue,maxValue,data):
    print "modeFunc_04"
    response = "%02X" % rand(0,255)
    response = "%s%s%s" % ((40+pidMode),'04', response)
    return response

def modeFunc_05(parent,pidMode,minValue,maxValue,data):
    print "modeFunc_05"
    response = "%02X" % rand(0,255)
    response = "%s%s%s" % ((40+pidMode),'05', response)
    return response
